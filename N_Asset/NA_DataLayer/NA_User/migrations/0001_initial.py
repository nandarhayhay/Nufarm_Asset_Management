# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-19 06:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=250, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_username', message='Username must be Alpahnumeric or contain any of the following: ".+ -" ', regex='^[a-zA-Z0-9.+-]*$')])),
                ...
                ('picture', models.ImageField(blank=True, default='default.png', height_field='height_field', null=True, upload_to='', verbose_name='profile picture', width_field='width_field')),
