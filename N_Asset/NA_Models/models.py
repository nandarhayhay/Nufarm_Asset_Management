...
class Employee(models.Model):
    ...
    typeapp = models.CharField(db_column='TypeApp', max_length=1, blank=True, null=True)  # Field name made lowercase.
...
class NAStock(models.Model):
    ...
    fk_goods_recieved = models.IntegerField(db_column='FK_Goods_Recieved', blank=True, null=True)  # Field name made lowercase.
